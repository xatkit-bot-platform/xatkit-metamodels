...
public class ExecutionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExecutionPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExecutionPackage.GUARDED_TRANSITION: {
			...
			case ExecutionPackage.AUTO_TRANSITION: {
				AutoTransition autoTransition = (AutoTransition)theEObject;
				T result = caseAutoTransition(autoTransition);
				if (result == null) result = caseTransition(autoTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExecutionPackage.STATE_CONTEXT: {
	 ...
	 * @generated
	 */
	public T caseAutoTransition(AutoTransition object) {
		return null;
	}
